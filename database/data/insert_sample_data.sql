...
-- ==========================================
INSERT INTO employment_history (id, employee_id, effective_date, event_type, department_code, paid_leave_days, hourly_wage, remarks, created_at, updated_at, updated_by)
VALUES
('eh-EMP001-001', (SELECT id FROM employees WHERE employee_number = 'EMP001'), '2024-04-01', 'HIRE', 'BPS課', 10, 1200.00, '入社', NOW(), NOW(), 'system'),
('eh-EMP002-001', (SELECT id FROM employees WHERE employee_number = 'EMP002'), '2023-06-01', 'HIRE', 'BPS課', 10, 2500.00, '入社', NOW(), NOW(), 'system'),
('eh-EMP002-002', (SELECT id FROM employees WHERE employee_number = 'EMP002'), '2024-01-01', 'SALARY_INCREASE', 'BPS課', NULL, 2600.00, '昇給', NOW(), NOW(), 'system'),
('eh-EMP003-001', (SELECT id FROM employees WHERE employee_number = 'EMP003'), '2024-01-15', 'HIRE', 'オンサイト課', 10, 1150.00, '入社', NOW(), NOW(), 'system'),
('eh-EMP004-001', (SELECT id FROM employees WHERE employee_number = 'EMP004'), '2022-09-01', 'HIRE', 'オンサイト課', 10, 2400.00, '入社', NOW(), NOW(), 'system'),
('eh-EMP004-002', (SELECT id FROM employees WHERE employee_number = 'EMP004'), '2023-04-01', 'TRANSFER', 'オンサイト課', NULL, 2400.00, '異動', NOW(), NOW(), 'system'),
('eh-EMP004-003', (SELECT id FROM employees WHERE employee_number = 'EMP004'), '2024-10-31', 'RETIRE', 'オンサイト課', NULL, 2400.00, '退職', NOW(), NOW(), 'system'),
('eh-EMP005-001', (SELECT id FROM employees WHERE employee_number = 'EMP005'), '2023-11-01', 'HIRE', 'CC課', 10, 1180.00, '入社', NOW(), NOW(), 'system'),
